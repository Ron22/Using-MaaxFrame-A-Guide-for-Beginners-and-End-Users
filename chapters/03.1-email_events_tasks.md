...
The Emails module tab is typically located under the Home tab on the navigation bar at the top of any MaaxFrame screen. Click the tab to access the Emails list view. You may also hover on the tab to display the Actions and Email menu. The Actions menu allows you to perform important actions within the module.
